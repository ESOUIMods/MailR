...
function MailR.SetMailboxActive(eventCode)
  ...
  if MailR.setHandlersOnFirstLoad then
    ...
    ZO_MainMenuSceneGroupBarButton1:SetHandler("OnMouseUp", function(...)
      MailR.HideGuildies()
      handlerFunc(...)
    end)
  end
...
function MailR.Init(eventCode, addOnName)
  ...
  EVENT_MANAGER:RegisterForEvent("MailR_AttachmentMoneyChanged", EVENT_MAIL_ATTACHED_MONEY_CHANGED,
    MailR.AttachmentMoneyChanged)
  ...
  ZO_ChatWindowMail:SetHandler("OnClicked", function(...)
    MailR.HideGuildies()
    handlerFunc(...)
  end)
  ...
  local panelData          = {
    ...
    version            = "2.5.06", --self.codeVersion,
